( function () {
    ...
    // variables for first parts of the game reading from up to down
    var startUp = document.getElementById('start_up');
    var playBtn = document.getElementById('play');
    var intro = document.getElementById('intro');
    var startGame = document.getElementById('start_game');
    var settings = document.getElementsByClassName('settings');
    var leftPlayer = document.getElementById('left_player');
    var rightPlayer = document.getElementById('right_player');
    ...
    startGame.addEventListener('click', function() {
        ...
        leftPlayer.className = 'showing';
        rightPlayer.className = 'showing';
        footer.className = 'showing'; 
    });


    // variables for the second half of the game 
